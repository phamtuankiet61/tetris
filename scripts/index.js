...
class Board {
    ...
    drawCell(x, y, colorId) {
        this.ctx.fillStyle = COLOR_MAPPINGS[colorId] || COLOR_MAPPINGS[WHITE_COLOR_ID];
        this.ctx.fillRect(x * BLOCK_SIDES, y * BLOCK_SIDES, BLOCK_SIDES, BLOCK_SIDES);
        this.ctx.fillStyle = 'black';
        this.ctx.strokeRect(x * BLOCK_SIDES, y * BLOCK_SIDES, BLOCK_SIDES, BLOCK_SIDES);
    }
